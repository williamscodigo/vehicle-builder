  ...
  createMotorbike(): void {
    inquirer
      ...
      .then((answers) => {
        ...
        // set the selectedVehicleVin to the vin of the motorvike
      ...
      .then((answers) => {
        ...
        if (answers.action === 'Print details') {
          ...
          if(selectedVehicle instanceof Truck) {
            ...
            console.log('Your selected vehicle cannot perform towing! - not a truck!');
          }
          ...
          if(selectedVehicle instanceof Motorbike) {
            ...
            console.log('Your selected vehicle cannot perform a wheelie! - not a moterbike!');
          }
